...
const Clientes = () => {
  ...
  const handleDelete = async () => {
    ...
    try {
      await axios.delete(`${API}/clientes/${deleteId}`);
            ...
            <Table>
              <TableHeader>
                <TableRow className="border-white/5 hover:bg-transparent">
                  ...
                  <TableHead className="text-gray-400 uppercase text-xs tracking-wider font-medium">CPF</TableHead>
                  <TableHead className="text-gray-400 uppercase text-xs tracking-wider font-medium">WhatsApp</TableHead>
                  <TableHead className="text-gray-400 uppercase text-xs tracking-wider font-medium">Email</TableHead>
                    ...
                    <TableCell className="text-right">
                      <div className="flex items-center justify-end gap-2">
                        <Link to={`/clientes/editar/${cliente.id}`}>
                          <Button size="sm" variant="ghost" className="text-gray-400 hover:text-blue-400 hover:bg-blue-400/10" data-testid={`btn-edit-${cliente.id}`}>
