...
const VendaDetail = () => {
  ...
  if (!venda) {
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-red-500">Venda não encontrada</div>
      </div>
    );
  }
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 no-print">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-white font-['Outfit']">Detalhes da Venda</h1>
              <p className="text-sm text-gray-400">ID: {venda.id.slice(0, 8)}...</p>
            </div>
          </div>
        </div>
        <Button 
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-white font-medium">{formatDate(venda.data)}</p>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-[#D4AF37] font-bold text-lg">{formatCurrency(venda.valor_total)}</p>
                </div>
              </div>
            </CardContent>
          </Card>
        ...
        <Card className="bg-[#141414] border border-white/5 mb-6">
          <CardHeader className="border-b border-white/5">
            <div className="flex items-center gap-3">
              ...
              <CardTitle className="text-lg font-semibold text-white">Itens da Venda</CardTitle>
            </div>
          </CardHeader>
            ...
            <Table>
              <TableHeader>
                <TableRow className="border-white/5 hover:bg-transparent">
                  ...
                  <TableHead className="text-gray-400 uppercase text-xs tracking-wider font-medium text-right">Preço</TableHead>
                </TableRow>
              </TableHeader>
              <TableBody>
                ...
                <TableRow className="border-white/5 bg-white/5">
                  <TableCell colSpan={3} className="text-right text-gray-400 uppercase text-sm font-semibold">
                    Total
                  </TableCell>
                  <TableCell className="text-[#D4AF37] font-bold text-lg text-right">
        ...
        {venda.observacao && (
          <Card className="bg-[#141414] border border-white/5">
            ...
            <CardContent className="p-6">
              <p className="text-gray-300">{venda.observacao}</p>
            </CardContent>
          </Card>
        )}
      </div>
