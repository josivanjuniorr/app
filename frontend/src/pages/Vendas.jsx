...
const Vendas = () => {
  ...
  const filteredVendas = vendas.filter((venda) =>
    ...
    venda.id.includes(search) ||
    formatDate(venda.data).includes(search)
  );
            ...
            <Table>
              <TableHeader>
                <TableRow className="border-white/5 hover:bg-transparent">
                  <TableHead className="text-gray-400 uppercase text-xs tracking-wider font-medium">Data</TableHead>
                  <TableHead className="text-gray-400 uppercase text-xs tracking-wider font-medium">Cliente</TableHead>
                  <TableHead className="text-gray-400 uppercase text-xs tracking-wider font-medium">Itens</TableHead>
                  <TableHead className="text-gray-400 uppercase text-xs tracking-wider font-medium">Pagamento</TableHead>
                  <TableHead className="text-gray-400 uppercase text-xs tracking-wider font-medium">Valor</TableHead>
